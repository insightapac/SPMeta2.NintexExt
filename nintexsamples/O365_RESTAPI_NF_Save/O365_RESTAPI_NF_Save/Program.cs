...
namespace O365_RESTAPI_NF_Save
{
    class Program
    {
        ...
        static private void SaveForm()
        {
            ...
            client.DefaultRequestHeaders.Add("Test-Environment", "01"); //delete for sample
            ...
            if (System.IO.File.Exists(importFileName))
            {
                ...
                {
                    Console.WriteLine("Failed to save form.");
                }
            }
        }
