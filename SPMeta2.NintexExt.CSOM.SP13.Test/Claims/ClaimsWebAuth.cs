...
namespace MSDN.Samples.ClaimsAuth
{
    ...
    public class ClaimsWebAuth : IDisposable
    {
        ...
        private CookieContainer fldCookies;
        ...
        /// Cookies returned from CLAIM server.
        /// </summary>
        public CookieContainer AuthCookiesContainer
        {
            get { return fldCookies; }
        }
        ...
        public CookieContainer Show()
        {
            ...
            this.fldCookies = ExtractAuthCookiesFromUrl(this.TargetSiteUrl);
